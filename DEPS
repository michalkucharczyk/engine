...
vars = {
  ...
  'dart_pub_rev': 'd15067931a6b671a1c9dcc98b5923347676269cf',
...
deps = {
  'src': 'https://github.com/dwrobel/buildroot.git@dw-5:f230f087e8408a8ba78989e7bf1ac84a4d357d92',
     ...
     'packages': [
       {
        ...
        'version': 'Q9HKIe4uSBsOGG_MNyOuqsVV6ZLQl3IuwiI4ThsH4JQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '_7JyV941rE763PwZ7OoX0N79LxUFM0v_4DLGTdctL98C'
       }
     ],
