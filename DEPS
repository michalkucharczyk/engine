...
vars = {
  ...
  'skia_revision': 'ebdae1144978a3943d76d9e0af2a7ffbbaf88937',
  ...
  'dart_revision': 'eb4ab613491b2965deba3157c33ca402b59d3b2d',
...
deps = {
  'src': 'https://github.com/dwrobel/buildroot.git',
     ...
     'packages': [
       {
        ...
        'version': 'DfLN8_TMKfvPWWLa_URfLaJnQqLSP_Z37dWnBi6e0QgC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'goLxs_DRN1ThzhJ6zlE2YXOT_6dMIVNhpRyG1plq-wAC'
       }
     ],
