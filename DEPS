...
deps = {
  'src': 'https://github.com/dwrobel/buildroot.git@dw-8:b20468d788eb766131d9c1d95b8840931fe2455a',
     ...
     'packages': [
       {
        ...
        'version': 'VpUd_W9Oi9zl5YqpFvs2iG-pkEumXH8Sbxk6YRbfUoIC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'sXR21ye3rKeLnKM_0SLX-MiTQWCEqW28qtkOcR5mpfAC'
       }
     ],
