...
deps = {
  'src': 'https://github.com/dwrobel/buildroot.git@dw-7:240d565b45fda04ec97f6303c36d6f6e4d46c804',
     ...
     'packages': [
       {
        ...
        'version': 'waj2pOhDhK4q8CAPY_wZ4jBKoLkG91lVeEiSXeq-NusC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '9tLNFbjA1iAo6NvfqlFEUvKyJSzGRD6jbV4JsPv1T4YC'
       }
     ],
